...
namespace Milestone4specflow.Steps
{
    ...
    public class ShampooStepDefinitions
    {
        ...
        [When(@"Check if First Search result Matches to given capture")]
        ...
        {
           termsofuseMethod.Scrolltonavigate();
        }

        [Then(@"click on terms of use")]
        public void ThenClickOnTermsOfUse()
        {
            termsofuseMethod.clickonterms();
        }
        ...
        {
           termsofuseMethod.prohibiteduses();
            termsofuseMethod.termsofusecapture();
        }
